      ...
      <el-table
        ...
        <el-table-column label="是否热销">
          <template slot-scope="scope">
            <el-tag v-if="scope.row.is_promote === false" type="danger">非热销品</el-tag>
            <el-tag v-else type="success">热销品</el-tag>
          </template>
        </el-table-column>
        <!--
        ...
        <el-table-column  label="操作">
          <template slot-scope="goodsList">
            <el-button
              ...
              size="mini"
              circle
              @click="editClickGood(goodsList.row.goods_id)"></el-button>
            <el-button
              type="danger"
              icon="el-icon-delete"
              plain
